        ...
        <div className="rounded-3xl border border-border bg-card shadow p-6">
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2">
            {[
              ...
              <div key={item} className="rounded-2xl border border-border bg-background p-4 text-sm leading-6 text-muted-foreground">
                <span className="mb-3 inline-flex h-8 w-8 items-center justify-center rounded-full bg-blue-100 font-semibold text-primary">✓</span>
                <p>{item}</p>
              </div>
            ))}
          </div>
